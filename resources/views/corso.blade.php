...
@section('content')
  ...
  <section class="why-boolean bg-white text-blue padding80 text-center">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3 class="title-section mb-4">Sei un principiante? <br>
            Nessun problema.
          </h3>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="content_corso p-3">
            <div class="row">
              <div class="col-lg-3">
                <img class="" src="{{asset('img/html.png')}}" alt="html-img">
              </div>
              <div class="col-lg-9">
                <h4>HTML 5 e CSS3</h4>
        ...
        <div class="col-lg-4">
          <div class="content_corso p-3">
            <div class="row">
              <div class="col-lg-3">
                <img class="" src="{{asset('img/js.png')}}" alt="javascript-img">
              </div>
              <div class="col-lg-9">
        ...
        <div class="col-lg-4">
          <div class="content_corso p-3">
            <div class="row">
              <div class="col-lg-3">
                <img class="" src="{{asset('img/php.png')}}" alt="php-img">
              </div>
              <div class="col-lg-9">
                <h4>PHP</h4>
      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="content_corso p-3">
            <div class="row">
              <div class="col-lg-3">
                <img class="" src="{{asset('img/mysql.png')}}" alt="mysql-img">
              </div>
              <div class="col-lg-9">
                <h4>MySQL e SQL</h4>
        ...
        <div class="col-lg-4">
          <div class="content_corso p-3">
            <div class="row">
              <div class="col-lg-3">
                <img class="" src="{{asset('img/laravel.png')}}" alt="laravel-img">
              </div>
              <div class="col-lg-9">
                <h4>Laravel</h4>
        ...
        <div class="col-lg-4">
          <div class="content_corso p-3">
            <div class="row">
              <div class="col-lg-3">
                <img class="" src="{{asset('img/vuejs.png')}}" alt="vuejs-img">
              </div>
              <div class="col-lg-9">
                <h4>VueJS</h4>
      ...
      <div class="row justify-content-around">
        <div class="col-lg-6">
          <div class="content p-0">
            <img class="thumbnail" src="{{asset('img/check.svg')}}" alt="check-img">
